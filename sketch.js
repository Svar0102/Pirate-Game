...
var brokenBoatSpritedata,brokenBoatSpreadsheet;
...
function preload() {
  ...
  brokenBoatSpreadsheet = loadImage("assets/boat/brokenBoat.png");
...
function setup() {
  ...
  for(var i = 0; i < brokenBoatFrames.length; i++){
    ...
    var img = brokenBoatSpreadsheet.get(pos.x,pos.y,pos.w,pos.h);
